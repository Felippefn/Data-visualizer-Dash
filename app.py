...
folder_path = r'C:\Users\felip\OneDrive\Documentos\Excel_archives'
file_type = '\*.xlsx'
...
one_df = df[df['Mês pesquisa'].isin(one_tt)]
two_df = df[df['Mês pesquisa'].isin(two_tt)]
three_df = df[df['Mês pesquisa'].isin(three_tt)]
four_df = df[df['Mês pesquisa'].isin(four_tt)]
...
def generate_indicator(dropdown_value, check_select, check_year):
    ...
    fig.update_traces(number_font_size=30, title_font_size=20, gauge_bar_line_width=2, gauge_bordercolor="black",
                      number_font_family='JetBrains Mono', delta_font_family='JetBrains Mono', legendgrouptitle_font_family='JetBrains Mono')
    return fig
...
def generate_pie(dropdown_value, check_select, check_year):
    ...
    fig.update_traces(legendgrouptitle_font_family='JetBrains Mono')
    return fig
...
def generate_indicator(dropdown_value, check_select, check_year):
    ...
    figScorees.add_trace(go.Indicator(
        mode="number",
        title={'text': "NPS Score<br><span style='font-size:0.8em;color:gray'>Mês selecionado</span><br><span style='font-size:0.8em;color:brown'>Mês atual</span>"},
        value=x,
    ...
    figScorees.update_layout(plot_bgcolor='#06182b',
                             paper_bgcolor='#06182b', font_color="white")
    figScorees.update_traces(number_font_size=56, delta_font_size=20, title_font_size=20, number_font_family='JetBrains Mono',
                             delta_font_family='JetBrains Mono', legendgrouptitle_font_family='JetBrains Mono')
    return figScorees
...
def generate_chart(dropdown_value, check_select, check_year):
    ...
    figScorew.update_traces(number_font_family='JetBrains Mono',
                            delta_font_family='JetBrains Mono', legendgrouptitle_font_family='JetBrains Mono')
    return figScorew
...
def generate_chart(dropdown_value, check_select, check_year):
    ...
    figScorew.update_layout(plot_bgcolor='#06182b',
                            paper_bgcolor='#06182b', font_color="white")
    figScorew.update_traces(number_font_size=30, delta_font_size=20, title_font_size=25, number_font_family='JetBrains Mono',
                            delta_font_family='JetBrains Mono', legendgrouptitle_font_family='JetBrains Mono')
    return figScorew
